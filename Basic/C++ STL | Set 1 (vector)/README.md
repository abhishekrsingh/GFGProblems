<h2><a href="https://practice.geeksforgeeks.org/problems/c-stl-set-1-vector/1?page=2&category=CPP&sortBy=submissions">C++ STL | Set 1 (vector)</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:20px">Implement different operations on a vector A .</span><br>
&nbsp;</p>
