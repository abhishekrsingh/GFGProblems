<h2><a href="https://practice.geeksforgeeks.org/problems/odd-or-even3618/1?page=1&category=CPP&sortBy=submissions">Odd or Even</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a positive integer N, determine whether it is odd or even.</span></p>
