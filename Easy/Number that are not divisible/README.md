<h2><a href="https://www.geeksforgeeks.org/problems/number-that-are-not-divisible4541/1?page=1&category=CPP&sortBy=submissions">Number that are not divisible</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You will be given a positive integer <strong>N</strong>. Your task is to find the number of positive integers <strong>K</strong>&nbsp;≤ <strong>N </strong>such that <strong>K</strong> is not divisible by any number among the set {2,3,4,5,6,7,8,9,10}.</span></p>
