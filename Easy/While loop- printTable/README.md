<h2><a href="https://practice.geeksforgeeks.org/problems/while-loop-printtable/1?page=1&category=CPP&sortBy=submissions">While loop- printTable</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><em><span style="font-size:18px">While loop is another loop like for loop but unlike for loop it only checks for one condition.</span></em></p>
