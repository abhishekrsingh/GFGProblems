<h2><a href="https://practice.geeksforgeeks.org/problems/step-by-step-condition/1?page=1&category=CPP&sortBy=submissions">Step by Step Condition</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p>Sometimes, the normal if-else isn't enough. In such cases, we have what we call ladder if and else conditions. So here we'll learn to use them.</p>
